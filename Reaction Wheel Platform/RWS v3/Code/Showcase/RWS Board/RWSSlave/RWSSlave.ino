...
#define MOTOR_MIDDLE_SPEED 754 //rad/s (non-zero minimum speed) //revert to this
...
void detumbleController(float reqWheelCombDH[], int dtMillis){
    ...
    float P = -0.003;  //for stairwell suspension test + showcase frame
...
void pointController(float reqWheelCombDH[], int dtMillis){
  ...
  float P = -0.0010;  //for stairwell suspension test //-0.001 for z
  float D =  0.0030;   //for stairwell suspension test //0.003 for z
