...
*/
/******************************************************************************/
void Motor_Control::detumble(angVelData_t *zero)
{
    double P = -0.1;
    // Serial.println("SatAngVel:\t\t" + String(_satAngVel->x) + "\t" + String(_satAngVel->y) + "\t" + String(_satAngVel->z));
    double error[3] {0.0, 0.0, 0.0};
    error[0] = zero->x - _satAngVel->x;
    error[1] = zero->y - _satAngVel->y;
    error[2] = zero->z - _satAngVel->z;
    // Serial.println("Error:\t" + String(error[0]) + "\t" + String(error[1]) + "\t" + String(error[2]));
    _satAngMom.x = P * error[0];
    _satAngMom.y = P * error[1];
    _satAngMom.z = P * error[2];
...
*/
/******************************************************************************/
void Motor_Control::updateMotor(angVelData_t *bias, messageData_t *message, int dtMillis)
{
